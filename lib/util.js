...
var doPost = function(options) {
  ...
  if (options.tableBody) {
    message = buildTableMessage(options.tableBody);
...
var doPut = function(options) {
  ...
  var md5 = (options.body) ? crypto.createHash('md5').update(options.body).digest('base64') : '';
...
var buildTableMessage = function(body) {
  return('<?xml version="1.0" encoding="utf-8" standalone="yes"?><entry xmlns:d="http://schemas.microsoft.com/ado/2007/08/dataservices" xmlns:m="http://schemas.microsoft.com/ado/2007/08/dataservices/metadata" xmlns="http://www.w3.org/2005/Atom"><title /><updated>' + dateFormat(Date(),"yyyy-mm-dd'T'HH:MM:ss'.0000000'o") + '</updated><author><name/></author><id/><content type="application/xml"><m:properties>' + body + '</m:properties></content></entry>');
