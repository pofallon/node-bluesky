...
module.exports = function(options) {
  ...
  Storage.table = function(t) {
    options.tableService || options.tableService = azure.createTableService(options.account, options.key);
  ...
  Storage.container = function(b) {
    options.blobService || options.blobService = azure.createBlobService(options.account, options.key);
